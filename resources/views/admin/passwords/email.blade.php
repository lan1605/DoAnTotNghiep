...
@section('title')
    <title>Gửi liên kết thay đổi mật khẩu dành cho quản trị viên</title>
@endsection
@section('content')
<div class="container">
                ...
                <div class="col-lg-6">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        @if (session('status'))
                            ...
                            <form method="POST" action="{{ route('admin.password.email') }}" class="form-body">
                                @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid gap-3">
                                            ...
                                            <a  href="{{ route('admin.login') }}" class="btn btn-lg btn-light radius-30">{{ __('Trở về trang đăng nhập') }}</a>
                                        @endif
                                            </div>
                                    </div>
                                </div>
