            ...
            <div class="container">
                <div class="row g-3 d-flex align-items-center mt-0 ">
                    <div class="d-sm-flex mb-3 justify-content-center gap-2">
                        <a href="/bai-hoc" class="btn btn-white mb-3 mb-lg-0">Tất cả</a>
                        <a href="/bai-hoc/danh-sach-da-luu" class="btn btn-primary mb-3 mb-lg-0">Bài học đã lưu</a>
                    </div>
                    ...
                    <div class="row g-0 d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-12 col-xl-12 ">
                            <div class="card-body p-2 p-sm-5 d-flex align-items-center justify-content-center flex-column">
                                ...
                                <a href="/bai-hoc" class="btn btn-primary mb-3 mb-lg-0">Quay lại danh sách bài học</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card ">
                                    ...
                                    <div class="pt-3">
                                        ...
                                        @endphp
                                            ...
                                            @if (($item->id_chude===$itemcd->id_chude) && ($items->id_baihoc === $item->id_baihoc))
                                            <div class="col-12 my-0 px-2">
                                                <div class="card w-100">
                                                    <div class="card-body" style="cursor: pointer" title="{{$item->ten_baihoc}}">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <a href="{{$items->luutru}}" class="text-black">
                                                                    <h6 class="mb-0 product--title">{{$item->ten_baihoc}}</h6>
                                                                </a>
                                                                
                                                            </div>
                                                            <div class="mb-0">
                                                                <a href="/bai-hoc/{{$item->slug}}/huy" class="btn btn-danger"><i class="bi-trash-fill"></i></a>
                                                            </div>
