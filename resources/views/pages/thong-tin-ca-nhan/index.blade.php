            ...
            <div class="row mt-5 mb-5">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <form class="row g-3" action="/thong-tin-ca-nhan" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-6">
                ...
                <div class="card shadow-sm border-0 overflow-hidden">
                    <div class="card-body">
                        ...
                        ?>" alt="" id="img" class=" rounded-circle shadow " width="120" height="120">
                                        ...
                                        <input type="file" name="img_hocvien" title="" value="{{$user->img_hocvien}}" id="img_hocvien" style="display:none" accept="image/png, image/gif, image/jpeg" >
                                        <label for="img_hocvien" class="bg-white hover-btn position-absolute px-2 py-1 rounded-circle shadow" style="z-index: 10000"><i class="bi bi-upload "></i></label>
                                        <style>
                                            .hover-btn{
                                            left: 55%;
                                            top: 70%;
                            ...
                            @enderror
                                        <script>
                                            ...
                                            const btnUpdateImg = document.querySelector("#img_hocvien");
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/thong-tin-ca-nhan/xoa" class="btn btn-danger">Xóa tài khoản</a>
                        </div>
                    </div>
                </div>
            </div>
