...
class BaiDangController extends Controller
{
    ...
    public function delete($id){
        ...
        if ($baidang){
            return redirect('dashboard/baiviet')->with('success','Bạn đã xóa thành công!');
        }
        else {
            return redirect('dashboard/baiviet')->with('errors', 'Thất bại, vui lòng thử lại!!');
        }
    }
    public function deleteAll(Request $req){
        $id = $req->ids;

        BaiDang::whereIn('id', $id)->delete();
    ...
    public function addPost(Request $req){
    	...
    	[
    		'ten_baidang.required'=>'bạn chưa nhập tên bài viết ',
            'ten_baidang.min'=>'tên bài viết ít nhất 2 ký tự',
            'noi_dung.required'=>'bạn chưa nhập nội dung bài viết ',
        ...
        if ($baidang) {
            return redirect('/goc-hoi-dap/them-moi')->with('success', 'Thêm bài viết thành công');
        }
        else {
    ...
    public function editPost(Request $req, $slug){
    	...
    	[
    		'ten_baidangEdit.required'=>'bạn chưa nhập tên bài viết ',
            'ten_baidangEdit.min'=>'tên bài viết ít nhất 2 ký tự',
            'noi_dungEdit.required'=>'bạn chưa nhập nội dung bài viết ',
